function [centeredStencilLHS, decenteredStencilLHS, decenteredStencilRHS, centeredStencilRHS, centeredStencilRHS2, decenteredStencilRHS2] = finiteDifferenceCoefficients(method)

% Adapted from https://github.com/marlonsmathias/GATT_DNS
...
switch method
    ...
    case 'EX2' % 2nd order explicit finite differences
        ...
        centeredStencilRHS2 = [-2 1];
        decenteredStencilRHS2 = [1 -2 1];
    ...
    case 'EX4' % 4nd order explicit finite differences
        ...
        centeredStencilRHS2 = [-5/2 4/3 -1/12];
        decenteredStencilRHS2 = [15/4 -77/6 107/6 -13 61/12 -5/6
                                 1 -2 1 0 0 0];
